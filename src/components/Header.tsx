    ...
    <header style={{ position: 'sticky', top: 0, zIndex: 40, background: 'rgba(246,240,228,.9)', backdropFilter: 'blur(10px)', borderBottom: '1px solid var(--line)' }}>
      <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 72 }}>
        <Link href="#top" style={{ display: 'flex', alignItems: 'center' }} aria-label="Ballcraft">
          <span style={{ fontFamily: 'var(--font-serif), Georgia, serif', fontSize: 24, fontWeight: 500, letterSpacing: '.24em', textTransform: 'uppercase', color: 'var(--accent-deep)', paddingLeft: 4 }}>Ballcraft</span>
        </Link>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
          ...
          <button onClick={openFavorites} aria-label="Вподобані" style={{ display: 'flex', alignItems: 'center', position: 'relative', background: 'none', border: 'none', padding: 0, color: 'inherit' }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z"></path></svg>
          ...
          <button className="btn btn-primary" onClick={open} style={{ padding: '9px 16px', display: 'flex', alignItems: 'center', gap: 6 }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>{count > 0 && <span>{count}</span>}
          </button>
